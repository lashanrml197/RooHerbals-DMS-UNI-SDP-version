    ...
    const fetchSupplierData = async () => {
      try {
        ...
        setFormData({
          ...
          is_preferred: supplierData.is_preferred === 1, // Convert 1/0 to boolean
        });
      } catch (error: any) {
  ...
  const handleSubmit = async () => {
    if (validateForm()) {
      try {
        ...
        Alert.alert(
          "Success",
          `Supplier "${formData.name}" has been updated successfully`,
          [
            {
              text: "OK",
        ...
        >
          ...
          <View style={styles.introSection}>
            <View style={styles.iconContainer}>
              <MaterialIcons name="edit" size={30} color={COLORS.light} />
            </View>
            <View style={styles.introTextContainer}>
              <Text style={styles.introTitle}>Edit Supplier</Text>
